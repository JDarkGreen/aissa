					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-7">
							...
							?>
								...
								<div id="carousel-single-product" class="section__single_gallery js-carousel-gallery" data-items="1" data-items-responsive="1" data-margins="5" data-dots="true" data-autoplay="false">
							...
							<?php else: ?>
								...
								<article class="containerRelative">
									...
									?>
									<a href="<?= $feat_image; ?>" class="gallery-fancybox">
							...
							<div class="detailItemProduct">
								...
								<div class="row">
									<?php  
										...
										$array_colors = !empty($array_colors) ? $array_colors[0] : array();
